...
import 'package:breaking_bad/ui/screens/character/character_quotes.dart';
        ...
        SliverList(
          delegate: SliverChildBuilderDelegate((_, index) {
            return Column(
              ...
              children: [
                CharacterInfo(
                    data: widget.character.nickname ?? APPStrings.noData),
                CharacterInfo(
                    data: widget.character.birthday ?? APPStrings.noData),
                CharacterInfo(
                    data: widget.character.category ?? APPStrings.noData),
                CharacterQuotes(
                    name: widget.character.name ?? APPStrings.noData)
              ],
            );
          }, childCount: 1),
        )
